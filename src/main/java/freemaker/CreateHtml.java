...
public class CreateHtml {
    ...
    public static void main(String[] args) {
        try {
            ...
            configuration.setDirectoryForTemplateLoading(new File("D:\\gamey-tmd\\playground\\src\\main\\java\\freemaker"));
            ...
            Writer writer  = new OutputStreamWriter(new FileOutputStream("D:\\gamey-tmd\\playground\\src\\main\\java\\freemaker\\success.html"),"UTF-8");
